...
import type { LeadLossInfo } from "../../types/lead.types";

interface LossReasonModalProps {
  isOpen: boolean;
  initialValue?: LeadLossInfo;
  isLoading?: boolean;
  onClose: () => void;
  onSubmit: (value: LeadLossInfo) => void;
}
...
export function LossReasonModal({
  ...
  const [formData, setFormData] = useState<LeadLossInfo>({
    reason: "",
    competitor: "",
    notes: "",
    lostAt: "",
