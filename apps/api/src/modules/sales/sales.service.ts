...
export class SalesService {
  ...
  private mapToResponse(sale: any): SaleResponseDto {
    ...
    return {
      ...
      approvedBy: sale.approvedBy || sale.approved_userId || "",
      approvedByName: sale.approvedByName || sale.approved_userName || "",
      approvedAt: sale.approvedAt,
      approvalStatus: sale.approvalStatus || "none",
      approvalRequestedBy: sale.approvalRequestedBy || "",
      approvalRequestedByName: sale.approvalRequestedByName || "",
      approvalRequestedAt: sale.approvalRequestedAt,
