...
export class PaymentsService {
   ...
   * NOT: Bu metod artik dogrudan cagrilmiyor. PayTR callback farkli bir API'ye gidiyor
   * ve o API MongoDB'deki online-payments koleksiyonunu guncelliyor.
   * Gercek is mantigi PaymentStatusChangeHandler tarafindan change stream uzerinden isleniyor.
   * Bu metod geriye donuk uyumluluk icin korunuyor.
   */
  async handleCallback(body: Record<string, any>): Promise<void> {
    ...
    // Odeme durumunu guncelle (change stream handler'i tetikler)
