...
export const PipelineRentalSchema =
  SchemaFactory.createForClass(PipelineRental);

PipelineRentalSchema.index({ parentId: 1, parentType: 1 });
PipelineRentalSchema.index({ pipelineRef: 1 });
