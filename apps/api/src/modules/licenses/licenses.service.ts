...
export class LicensesService {
  ...
  private mapToResponseDto(license: License, haveContract: boolean): LicenseResponseDto {
    return {
      ...
      address: {
        address: license.address?.address || "",
        cityId: license.address?.cityId || 0,
        city: license.address?.city || "",
        townId: license.address?.townId || 0,
        town: license.address?.town || "",
        districtId: license.address?.districtId || 0,
        district: license.address?.district || "",
        countryId: license.address?.countryId || "",
        country: license.address?.country || "",
      },
      phone: license.phone,
      email: license.email,
